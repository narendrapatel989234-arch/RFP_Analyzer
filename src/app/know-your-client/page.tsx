      ...
      <main className={styles.container}>
        ...
        <section>
          ...
          {uploadedDoc ? (
            <div 
              ...
              onClick={() => isFromFunctionalConfirmation && setPreviewDoc(uploadedDoc)}
            >
              <div className={styles.fileListItem}>
                ...
                {!isFromFunctionalConfirmation && <span className={styles.fileListSize}>{uploadedDoc.size}</span>}
        ...
        <section>
          <div className={styles.summaryHeader}>
            <label className={styles.sectionLabel} style={{ marginBottom: 0 }}>Know Your Client</label>
            {!isFromFunctionalConfirmation && (
              <button
        ...
        <div className={styles.actionRow} style={{ justifyContent: 'flex-end', marginTop: 'var(--space-4)' }}>
          <button
            ...
            onClick={() => {
              if (isFromFunctionalConfirmation) {
                router.push(`/rfp-details?from=functional-confirmation&rfpId=${rfpId}`)
              } else {
