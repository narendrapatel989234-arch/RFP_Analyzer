...
import styles from './CapabilitiesModalV2.module.css'
import pageStyles from '../app/solution-strategy-v2/page.module.css'
import {
  ExtractedDocument,
  ExtractionDropzone,
  OutlineNode,
...
export function CapabilitiesModalV2({
