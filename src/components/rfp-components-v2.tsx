...
import styles from '../app/solution-strategy-v2/page.module.css'
      ...
      {!readOnly && (
        <>
          ...
          >
            ...
            <div className={styles.uploadText}>
              <span style={{ color: 'var(--text-primary)', fontWeight: 'bold' }}>Drop your files here or </span>
              <span style={{ color: 'var(--Lavender-600)', fontWeight: 'bold' }}>Browse</span>
            </div>
            <div className={styles.uploadHint}>
...
export function ExtractionDropzone({ label: _label, onDrop }: { label: string, onDrop: (f: File) => void }) {
  ...
  return (
    ...
    >
      ...
      <div className={styles.uploadText}>
        <span style={{ color: 'var(--text-primary)', fontWeight: 'bold' }}>Drop your file here or </span>
        <span style={{ color: 'var(--Lavender-600)', fontWeight: 'bold' }}>Browse</span>
      </div>
      <div className={styles.uploadHint}>
        Format: PDF, DOCX &mdash; Max file size: 25 MB
