...
import styles from './ProposalReviewV2.module.css'

export function ProposalReviewV2() {
  const [viewState, setViewState] = useState<'form' | 'review'>('review');
                ...
                {activeTab === 'Proposal' && (
                  <>
                      ...
                      <div className={styles.proposalCardHeader}>
                        <div className={styles.cardHeaderFlex}>
                          ...
                          <div className={styles.cardHeaderRight}>
                            ...
                            <button className={styles.iconBtn} onClick={() => setShowRegenerateModal('company')} title="Regenerate Section">
                        ...
                        {editingSection === 'company' ? (
                          ...
                          <div>
                            ...
                            <ul className={styles.checkList} style={{ marginTop: '16px' }}>
                              <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> 120+ enterprise platform deliveries across banking, public sector, and judiciary domains, focusing on high-availability and zero-downtime migrations.</li>
                              <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> Dedicated, specialized practices for cloud infrastructure (AWS, Azure), advanced data engineering, and applied artificial intelligence (RAG, LLMs).</li>
                              <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> Rigorous ISO 27001, ISO 9001, and SOC 2 Type II compliant delivery processes, guaranteeing the highest international standards of information security.</li>
                              <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> Comprehensive ongoing L1/L2/L3 support operations available 24/7/365 with highly restrictive internal SLAs for critical public infrastructure.</li>
                            </ul>
                          </div>
                        )}
                      </div>
                    ...
                    <div className={styles.proposalCard}>
                      <div className={styles.proposalCardHeader}>
                        <div className={styles.cardHeaderFlex}>
                          ...
                          <div className={styles.cardHeaderRight}>
                            <button className={styles.iconBtn} onClick={() => setShowRegenerateModal('scope')} title="Regenerate Section">
                              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="23 4 23 10 17 10" /><polyline points="1 20 1 14 7 14" /><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15" /></svg>
                            </button>
                          </div>
                        </div>
                      ...
                      <div className={styles.proposalCardBody}>
                        ...
                        <div style={{ marginTop: '32px', paddingTop: '32px', borderTop: '1px solid #E2E8F0' }}>
                          <h3 style={{ fontSize: '18px', fontWeight: 600, color: 'var(--Content-Primary)', marginBottom: '24px' }}>UC1 — AI Legislative Avatar</h3>
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
                            ...
                            <div>
                              ...
                              <ul className={styles.checkList}>
                                <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> Custom LLM fine-tuning and prompt engineering specifically optimized for UAE Federal Law and ADJD local regulations.</li>
                                <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> Real-time bilingual (Arabic/English) voice interaction with dynamic language switching and sub-second latency.</li>
                                <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> Real-time photorealistic avatar streaming with localized cultural attire and context-aware conversational gestures.</li>
                                <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> Automated corpus ingestion pipelines to keep the legal database updated continuously without system downtime.</li>
                              </ul>
                            </div>
                            ...
                            <div>
                              ...
                              <ul className={styles.checkList}>
                                <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> API rate limits and concurrency caps from the external avatar streaming provider remain scalable to at least 1,000 concurrent sessions.</li>
                                <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> ADJD supplies the fully vetted, translated, and structured XML/JSON formatted legal corpus no later than Project Week 2.</li>
                              </ul>
                            </div>
                          </div>
                        </div>
                        ...
                        {/* Nested UC2 */}
                        <div style={{ marginTop: '32px', paddingTop: '32px', borderTop: '1px solid #E2E8F0' }}>
                          <h3 style={{ fontSize: '18px', fontWeight: 600, color: 'var(--Content-Primary)', marginBottom: '24px' }}>UC2 — Smart Case Filing Portal</h3>
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
                            <div>
                              <div className={styles.ucSectionTitle}>PROBLEM UNDERSTANDING</div>
                            ...
                            <div>
                              <div className={styles.ucSectionTitle}>SCOPE COVERAGE</div>
                              <ul className={styles.checkList}>
                                <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> AI-driven preliminary case classification achieving at least 92% confidence based on historical benchmarking data.</li>
                                <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> Secure, chunked document upload service with automated OCR validation for UAE ID and Passport scans.</li>
                                <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> Seamless, bidirectional integration with the legacy ADJD CMS via enterprise SOAP bridges and dedicated message queues.</li>
                                <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> Built-in UAE Pass authentication integration for instant citizen identity verification and secure digital signatures.</li>
                              </ul>
                            </div>
                            ...
                            <div>
                              <div className={styles.ucSectionTitle}>ASSUMPTIONS & DEPENDENCIES</div>
                              <ul className={styles.checkList}>
                                <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> Existing legacy SOAP endpoints remain completely stable, well-documented, and do not undergo breaking changes during the implementation phase.</li>
                                <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> UAE Pass staging environments and API credentials will be provisioned by the relevant authorities without significant bureaucratic delays.</li>
                              </ul>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className={styles.proposalCard}>
                      <div className={styles.proposalCardHeader}>
                        <div className={styles.cardHeaderFlex}>
                          ...
                          <div className={styles.cardHeaderRight}>
                            ...
                            <button className={styles.iconBtn} onClick={() => setShowRegenerateModal('deliverables')} title="Regenerate Section">
                              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="23 4 23 10 17 10" /><polyline points="1 20 1 14 7 14" /><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15" /></svg>
                            </button>
                          </div>
                        </div>
                      ...
                      <div className={styles.proposalCardBody}>
                        ...
                        {editingSection === 'deliverables' ? (
                          ...
                          <ul className={styles.checkList}>
                            <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> Fully documented source code stored in a secure, ADJD-hosted Git repository, complete with comprehensive inline comments and architectural decision records (ADRs).</li>
                            <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> Complete Infrastructure as Code (IaC) Terraform and Ansible scripts for repeatable, automated deployments across staging and production environments.</li>
                            <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> Comprehensive Administrator, Operations, and User Manuals, including video walkthroughs and standard operating procedures (SOPs) for the L1 support team.</li>
                            <li><span style={{ color: 'var(--Content-Primary-400)' }}>•</span> A fully populated Postman API collection covering all microservices, complete with mock data payloads and automated test assertions.</li>
                          </ul>
                        )}
                      </div>
                    </div>
                      ...
                      <div className={styles.proposalCardHeader}>
                        <div className={styles.cardHeaderFlex}>
                          ...
                          <div className={styles.cardHeaderRight}>
                            ...
                            <button className={styles.iconBtn} onClick={() => setShowRegenerateModal('risks')} title="Regenerate Section">
                              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="23 4 23 10 17 10" /><polyline points="1 20 1 14 7 14" /><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15" /></svg>
                            </button>
                          </div>
                        </div>
                    ...
                    <div className={styles.proposalCard}>
                      <div className={styles.proposalCardHeader}>
                        <div className={styles.cardHeaderFlex}>
                          ...
                          <div className={styles.cardHeaderRight}>
                            ...
                            <button className={styles.iconBtn} onClick={() => setShowRegenerateModal('caseStudies')} title="Regenerate Section">
                              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="23 4 23 10 17 10" /><polyline points="1 20 1 14 7 14" /><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15" /></svg>
                            </button>
                          </div>
                        </div>
                      ...
                      <div className={styles.proposalCardBody}>
                        {regeneratingSection === 'caseStudies' && (
                          <div className={styles.shimmerOverlay}>
                            <div className={styles.shimmerText}>
                              <svg className={styles.shimmerSpinner} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="16" height="16">
                                <line x1="12" y1="2" x2="12" y2="6"></line><line x1="12" y1="18" x2="12" y2="22"></line><line x1="4.93" y1="4.93" x2="7.76" y2="7.76"></line><line x1="16.24" y1="16.24" x2="19.07" y2="19.07"></line><line x1="2" y1="12" x2="6" y2="12"></line><line x1="18" y1="12" x2="22" y2="12"></line><line x1="4.93" y1="19.07" x2="7.76" y2="16.24"></line><line x1="16.24" y1="7.76" x2="19.07" y2="4.93"></line>
        ...
        <div className={styles.modalOverlay}>
          <div className={styles.modalCard}>
            ...
            <div className={styles.modalActions}>
              <button className={styles.ctaSecondary} onClick={() => setShowRegenerateModal(null)}>Cancel</button>
              <button className={styles.ctaPrimary} onClick={() => {
                const sectionToRegen = showRegenerateModal;
                setShowRegenerateModal(null);
                setRegenPrompt("");
                if (sectionToRegen) {
                  setRegeneratingSection(sectionToRegen);
                  setTimeout(() => {
